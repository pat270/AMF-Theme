	...
	<header class="ac-header" id="banner" role="banner">
		<div class="container">
			...
			<div class="ac-header-right">
				...
				<#-- SEARCH -->
				<button aria-controls="search" aria-expanded="false" class="ac-header-search-toggle ac-header-btn btn visible-xs-block" data-target="#acHeaderSearchBar" data-toggle="collapse" type="button">
					<svg class="lexicon-icon lexicon-icon-search" role="img" title="" viewBox="0 0 512 512">  
